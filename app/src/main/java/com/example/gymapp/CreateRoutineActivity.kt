...
class CreateRoutineActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val routine2 = Routine("exercise$exerciseCount", 2.minutes, Weight(100f, WeightUnit.kg),
            10, ExactReps(3), Rpe(8), Pace(2,0,2,1)
        )
        exerciseCount ++
        val routine1 = Routine("exercise$exerciseCount", 4.minutes, Weight(70f, WeightUnit.kg),
